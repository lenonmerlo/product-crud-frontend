...
export function RegisterScreen({ onLogin, onGoToLogin }: Props) {
  ...
  async function onSubmit(data: RegisterInput) {
    try {
      ...
      await SecureStore.setItemAsync("user", JSON.stringify(loginResponse.data.user));
      onLogin();
    } catch (err) {
    ...
    >
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.description}>Abra seu acesso ao painel comercial.</Text>
